"""Demonstrate inconsistent tir primfunc printing."""
import hashlib
...
def conv2d_layer(N, H, W, CO, CI, KH, KW, stride, padding):
    ...
    kernel = te.placeholder((CO, CI, KH, KW), name="data")
    bias = te.placeholder((1, CO, 1, 1), name="data")
...
if __name__ == "__main__":
    ...
    for _ in range(100):
        ...
        print(hashlib.sha256(str(primfunc).encode()).hexdigest())